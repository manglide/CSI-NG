...
const URL = '/chartsreviewdislikes';

class HighChartsReviewDisLikes extends React.Component  {
  constructor() {
    super();
  ...
  componentDidMount() {
    ...
    .then(res => {
      ...
      if (areas.length === 0) {
        window.makeBarChartHighDisLikes(areas);
      } else {
        window.makeBarChartHighDisLikes(areas);
      }
    })
...
export default HighChartsReviewDisLikes;
